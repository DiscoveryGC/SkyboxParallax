...
namespace Archetype
{
	...
	public:
		...
		/* 41 */ float fOfflineRebuildTime;
		/* 42 */ uint stdVectorHpShieldType[4];
	};
	...
	public:		
		...
		/* 66 */ Vector	vAngularDrag;
		/* 69 */ Vector	vSteeringTorque;
...
public:
	...
	float hitPts;
	uint dunnoCAttached;
	bool dunnoCAttached2;
	uint dunnoCAttached3[4];
};
...
public:
	...
	uint dockingAnimationsVectorAllocator;                     // 96
	uint dockingAnimationVector[3];                            // 97 could be st6::vector<IAnimation2>, on VS2008 vectors are six 24 bytes instead of sane 12 
...
public:
	...
	bool recalculateGunStats;                 // 177
	ShipGunStats gunStats;
};
...
struct IMPORT CSolar : public CEqObj
{
	...
	public:
		uint iHash;
		float fDunno[2]; // (~0, 0, -1) in float consistently
		float fHitPoints;
		Vector vPos;
		Matrix mOrientation;
		int iDunno1[3];
